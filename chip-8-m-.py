...
# -*- coding: utf-8 -*-
"""
progarm.py — CHIP‑8 emulator with an mGBA‑style Qt GUI
------------------------------------------------------
...
display), plus timers and keypad. The GUI is intentionally arranged to
resemble mGBA’s Qt interface (menus, status bar, pause/step, speed control),
but does not depend on mGBA.
...
class MGBAStyleMainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("mGBA‑style CHIP‑8 Emulator")
        self.resize(900, 600)
    ...
    def action_about(self):
        QtWidgets.QMessageBox.information(
            self, "About",
            "CHIP‑8 emulator with an mGBA‑style Qt GUI\n\n"
            ...
            "This project is not affiliated with mGBA; it only mimics its UI style."
        )
