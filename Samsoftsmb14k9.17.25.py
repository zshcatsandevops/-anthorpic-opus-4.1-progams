...
pygame.display.set_caption("TEAM SAMSOFT ultra mario 2d bros")
    ...
    def run(self):
        ...
        while running:
            ...
            if self.game_state == STATE_OVERWORLD:
                ...
                title_font = pygame.font.SysFont("Arial", 24, bold=True)  # Smaller title font for longer text
                title = title_font.render("TEAM SAMSOFT ultra mario 2d bros", True, RED)
